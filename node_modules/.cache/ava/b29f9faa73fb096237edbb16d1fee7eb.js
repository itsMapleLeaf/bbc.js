...
test('parsing', t => {
  test('matching a single text node', t => {
    t.deepEqual(bbc.parse(bbc.tokenize('foo bar')), [{ type: 'text', text: 'foo bar' }]);
  });
...
//# sourceMappingURL=node_modules/.cache/ava/b29f9faa73fb096237edbb16d1fee7eb.js.map