...
test('matching tag params', t => {
  t.deepEqual(bbc.tokenize('[color=red]i am red[/color]'), [{ type: 'start-tag', text: '[color=red]', tag: 'color', param: 'red' }, { type: 'text', text: 'i am red' }, { type: 'end-tag', text: '[/color]', tag: 'color' }]);
});
...
test('parsing unmatched end tags as text', t => {
  t.deepEqual(bbc.parseBBC('[/foo][/bar]'), [{ type: 'text', text: '[/foo]' }, { type: 'text', text: '[/bar]' }]);
  t.deepEqual(bbc.parseBBC('[/foo] test [/bar]'), [{ type: 'text', text: '[/foo]' }, { type: 'text', text: ' test ' }, { type: 'text', text: '[/bar]' }]);
});
...
test('configured rendering', t => {
  t.is(bbc.renderBBC('[b]foo[/b] [i]bar[/i]', bbc.tags.common), '<strong>foo</strong> <em>bar</em>');
});
//# sourceMappingURL=node_modules/.cache/ava/c9db52aeb22a7d5119f1e96ecbfe9573.js.map