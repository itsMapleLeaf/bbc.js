...
test('parsing unmatched end tags', t => {
  t.deepEqual(bbc.parseText('[/foo] [/bar]'), [{ type: 'text', text: '[/foo]' }, { type: 'text', text: ' ' }, { type: 'text', text: '[/bar]' }]);
});
...
//# sourceMappingURL=node_modules/.cache/ava/5d6079d6bf1762e705346a718f8de976.js.map